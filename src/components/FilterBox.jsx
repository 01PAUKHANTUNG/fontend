...
const FilterBox = ({products, setResult}) => {
    ...
    <div className='py-4'>
      <div className='flex justify-between'>
        <div className='flex flex-col gap-2'>
         ...
         <select onChange={(e)=>{setFilter(e.target.value)}}  className='w-[300px] py-2 px-2 items-center border-2 border-gray-500'>
         ...
         <select onChange={(e)=>{setSort(e.target.value)}} className='w-[300px] py-2 px-2 items-center  border-2 border-gray-500'>
