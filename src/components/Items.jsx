...
const Items = (props) => { 
  ...
  return (
    <div className={`${props.stockavaiable ? 'hover:shadow-lg':' cursor-not-allowed'} w-[350px] h-auto flex flex-col gap-2 py-4 px-6 border-2 rounded-xl `}>
      <div className='flex group relative justify-center items-center'>
        <img className={`${props.stockavaiable ? "hover:scale-110 ":'hover:cursor-not-allowed'} w-[200px] h-[200px] cursor-pointer m-6 `} src={props.image} alt='' />
